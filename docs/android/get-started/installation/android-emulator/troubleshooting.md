...
occur while configuring and running the Android Emulator are described, along
with workarounds and tips._
...
Emulator. These warning dialogs are explained below.
...
If the Android Emulator does not start properly, this is often
