...
### [Embedding .NET in Java](platform/embedding-net-in-java.md)
...
##### [Walkthrough](platform/fragments/implementing-with-fragments/walkthrough.md)
##### [Supporting pre-Honeycomb](platform/fragments/implementing-with-fragments/supporting-pre-honeycomb.md)
...
### [Azure Connected Services](~/cross-platform/data-cloud/connected-services.md?context=xamarin/android)
...
##### [Running the Emulator](deploy-test/debugging/android-sdk-emulator/running-the-emulator.md)
##### [Troubleshooting](deploy-test/debugging/android-sdk-emulator/troubleshooting.md)
