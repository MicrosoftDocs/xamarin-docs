...
[ ![](hello-tvos-images/run05.png "Example app run")](hello-tvos-images/run05.png)
...
3. Select **tvOS** > **App** > **Single View App** and click the **Next** button:
	...
	[ ![](hello-tvos-images/setup02.png "Select Single View App")](hello-tvos-images/setup02.png)
...
Visual Studio for Mac will create the new Xamarin.tvOS app and display the default files that get added to your application's solution:
 ...
 [ ![](hello-tvos-images/project01.png "The default files view")](hello-tvos-images/project01.png)
...
[ ![](hello-tvos-images/designer01.png "The Main.storyboard file in the Solution Explorer")](hello-tvos-images/designer01.png)

This should launch the Designer and look like the following:

[ ![](hello-tvos-images/designer02.png "The Designer")](hello-tvos-images/designer02.png)
...
1. Locate the **Toolbox**, which should be to the right of the design surface:
	...
	[![](hello-tvos-images/designer03.png "The Toolbox")](hello-tvos-images/designer03.png)

	If you can't locate it here, browse to **View > Pads > Toolbox** to view it.
2. Drag a **Label** from the **Toolbox** to the design surface:

	[ ![](hello-tvos-images/designer04.png "Drag a Label from the Toolbox")](hello-tvos-images/designer04.png)
3. Click on the **Title** property in the **Property pad** and change the button's title to `Hello, tvOS` and set the **Font Size** to 128:
	...
	[ ![](hello-tvos-images/designer05.png "Set the title to Hello, tvOS and set the Font Size to 128")](hello-tvos-images/designer05.png)
4. Resize the label so that all of the words are visible and place it centered near the top of the window:

	[ ![](hello-tvos-images/designer06.png "Resize and center the label")](hello-tvos-images/designer06.png)
5. The label will now need to be constrained to it's position, so that it appears as intended. regardless of screen size. To do this, click on the label until the *T-shaped handle* appears:
	...
	[ ![](hello-tvos-images/designer07.png "The T-shaped handle")](hello-tvos-images/designer07.png)
6. To constrain the label horizontally, select the center square and drag it to the vertically dashed line:

	[ ![](hello-tvos-images/designer08.png "Select the center square")](hello-tvos-images/designer08zoom.png)

	 The label should turn orange.
7. Select the T handle at the top of the label, and drag it to the top edge of the window:

	[ ![](hello-tvos-images/designer09.png "Drag the handle to the top edge of the window")](hello-tvos-images/designer09.png)
8. Next, click the width and then the height *bone handle* as illustrated below:

	[ ![](hello-tvos-images/designer10.png "The width and the height bone handles")](hello-tvos-images/designer10.png)
...
9. When completed, your Constraints should look similar to those in the Layout tab of the Properties pad:
	...
	[ ![](hello-tvos-images/designer11.png "Example Constraints")](hello-tvos-images/designer11.png)
...
9. Click on the **Title** property in the **Property pad** and change the button's title to `Click Me`:
	...
	[ ![](hello-tvos-images/designer12.png "Change the buttons title to Click Me")](hello-tvos-images/designer12.png)
10. Repeat steps 5 to 8 above to constrain the button in the tvOS window. However, instead of dragging  the T-handle to the top of the window (as in step #7), drag it to the bottom of the label:
	...
	[ ![](hello-tvos-images/designer14.png "Constrain the button")](hello-tvos-images/designer14.png)
11. Drag another label under the button, size it to be the same width as the first label and set its **Alignment** to **Center**:

	[ ![](hello-tvos-images/designer15.png "Drag another label under the button, size it to be the same width as the first label and set its Alignment to Center")](hello-tvos-images/designer15.png)
12. Like the first label and button, set this label to center and pin it into location and size:

	[ ![](hello-tvos-images/designer16.png "Pin the label into location and size")](hello-tvos-images/designer16.png)
...
[ ![](hello-tvos-images/designer17.png "The Document Outline section")](hello-tvos-images/designer17.png)
...
2. In the Properties pad, select the **Events** tab:
	...
	[![](hello-tvos-images/event1.png "The Events tab")](hello-tvos-images/event1.png)
3. Locate the TouchUpInside event, and give it an event handler named `Clicked`:

	[![](hello-tvos-images/event2.png "The TouchUpInside event")](hello-tvos-images/event2.png)
4. When you press **Enter**, the **ViewController**.cs file will open, suggesting locations for your event handler in code. Use the arrow keys on your keyboard to set the location:
	...
	[![](hello-tvos-images/event3.png "Setting the location")](hello-tvos-images/event3.png)
5. This will create a partial method as shown below:

	[![](hello-tvos-images/event4.png "The partial method")](hello-tvos-images/event4.png)
...
2. In the Properties pad, select the **Widget** tab:
	...
	[![](hello-tvos-images/name1.png "Select the Widget tab")](hello-tvos-images/name1.png)
3. Under **Identity > Name**, add `ClickedLabel`:

	[![](hello-tvos-images/name2.png "Set ClickedLabel")](hello-tvos-images/name2.png)
...
[ ![](hello-tvos-images/accesscontrol.png "Outlets and Actions")](hello-tvos-images/accesscontrol.png)
...
[ ![](hello-tvos-images/code01.png "The Solution Pad")](hello-tvos-images/code01.png)
...
[ ![](hello-tvos-images/run01.png "Select the type of build")](hello-tvos-images/run01.png)
...
[ ![The sample app home screen](hello-tvos-images/run03.png)](hello-tvos-images/run03.png)

From the **Hardware** menu select **Show Apple TV Remote** so you can control the simulator.

[ ![](hello-tvos-images/run04.png "Select Show Apple TV Remote")](hello-tvos-images/run04.png)

Using the Simulator's remote, if you click the button a few times the label should be updated with the count:

[ ![](hello-tvos-images/run05.png "The label with updated count")](hello-tvos-images/run05.png)
