...
iCloud Photo Library. CloudKit is supported on both Mac OS X and Apple iOS Devices.
 ...
 [![How CloudKit is supported on both Mac OS X and Apple iOS Devices](intro-to-cloudkit-images/image1.png)](intro-to-cloudkit-images/image1.png#lightbox)
...
2. In the **Solution Explorer**, open the **Info.plist** file and ensure the **Bundle Identifier** matches the one that was defined in **App ID** created as part of the provisioning set up:
    ...
    [![Enter the Bundle Identifier")](intro-to-cloudkit-images/image26a-orig.png#lightbox "Info.plist file displaying Bundle Identifier](intro-to-cloudkit-images/image26a.png)
...
3. Scroll down to the bottom of the **Info.plist** file and select **Enabled Background Modes**, **Location Updates** and **Remote Notifications**:
    ...
    [![Select Enabled Background Modes, Location Updates and Remote Notifications")](intro-to-cloudkit-images/image27a-orig.png#lightbox "Info.plist file displaying background modes](intro-to-cloudkit-images/image27a.png)
