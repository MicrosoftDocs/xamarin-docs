...
pane in Visual Studio for Mac or Visual Studio:
 ...
 [ ![](encodings-images/00.png "Selecting the extra encodings")](encodings-images/00.png)

 [ ![](encodings-images/00a.png "Selecting the extra encodings")](encodings-images/00a.png)
