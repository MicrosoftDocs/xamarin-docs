...
![Scenes can be pushed onto the navigation stack](navigation-images/hierarchy-1.png)
![Scenes can be popped off of the navigation stack](navigation-images/hierarchy-2.png)
...
![Sample first page](navigation-images/paged-1.png)
![Sample second page](navigation-images/paged-2.png)
![Sample fifth page](navigation-images/paged-5.png)
