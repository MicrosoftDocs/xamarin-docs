...
The **Project->iPhone Simulator Target**> menu can be used to pick the simulator 
...
This message is caused by attempting to open .xib files when environment variables
