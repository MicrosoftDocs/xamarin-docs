...
_Near Field Communication_ (NFC) radio to read tags from within apps. It works on iPhone 6, 6 Plus, 7, 7 Plus, 8, 8 Plus, and X (Iphone 6, 6 Plus works only for NFC payments not NFC tags).
