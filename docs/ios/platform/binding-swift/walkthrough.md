...
1. In order to submit the app to the app store you want to use Xcode and distribute option, which will update the IPA file and Swift SupportFolder dylibs so it will be accepted by the AppStore:
