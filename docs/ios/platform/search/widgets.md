...
[ ![](widgets-images/widgets01.png "Example widgets")](widgets-images/widgets01.png)
...
- **Inform when Authentication Adds Value** - If additional functionality or information is available only when the user is authenticated and signed on, present this to the user. For example, a ride sharing app my say "Sign in to book ride".
