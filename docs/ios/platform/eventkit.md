...
application:
 ...
 [ ![](eventkit-images/01.png "The companion sample application screens")](eventkit-images/01.png)
...
to the user when using the Calendar Application:
 ...
 [ ![](eventkit-images/02.png "The UI that is presented to the user when using the Calendar Application")](eventkit-images/02.png)
