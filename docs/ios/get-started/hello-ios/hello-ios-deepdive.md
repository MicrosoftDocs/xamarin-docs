...
- [**Sketch**](https://www.sketchapp.com") – Sketch is a Mac app for designing user interfaces, icons, and more. This is the app that was used to design the Xamarin App Icons and Launch Images set. Sketch 3 is available on the App Store. You can try out the free [Sketch Tool](https://bohemiancoding.com/sketch/tool/) as well.
- [**Pixelmator**](https://www.pixelmator.com/) – A versatile image editing app for Mac that costs about $30.
- [**Glyphish**](https://www.glyphish.com/) – High-quality prebuilt icon sets for free download and purchase.
