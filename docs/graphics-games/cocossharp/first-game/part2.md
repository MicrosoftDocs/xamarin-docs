...
![](part2-images/image1.png "The finished game will look like this")
...
![](part2-images/image1.png "Run the game and see that it displays a score which increments as the ball bounces off of the paddle")
