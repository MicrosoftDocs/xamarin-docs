...
### [Console apps](app-fundamentals/console.md)
...
### [Introduction to macOS Mojave](platform/introduction-to-macos-mojave/index.md)
#### [Getting Started](platform/introduction-to-macos-mojave/get-started.md)
### [Introduction to macOS High Sierra](platform/introduction-to-macos-high-sierra/index.md)
...
### [HttpClient and SSL/TLS Implementation Selector](~/cross-platform/macios/http-stack.md?context=xamarin/mac)
### [Build Optimizations](~/cross-platform/macios/optimizations.md?context=xamarin/mac)
