...
Describes the rationale behind the Unified API and explains the
differences from the Classic API in detail. Refer to this page
to understand the changes that have been made in the Unified API.
