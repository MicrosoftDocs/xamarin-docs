...
#### [Customizing a WebView](app-fundamentals/custom-renderer/hybridwebview.md)
...
#### [Reusable RoundEffect](app-fundamentals/effects/reusable-roundeffect.md)
...
### Controls reference
#### [Overview](user-interface/controls/index.md)
...
#### [Image](user-interface/images.md)
#### [Label](user-interface/text/label.md)
#### Map
##### [Overview](user-interface/map/index.md)
##### [Initialization and Configuration](user-interface/map/setup.md)
##### [Map Control](user-interface/map/map.md)
##### [Position and Distance](user-interface/map/position-distance.md)
...
##### [Launch the Native Map App](user-interface/map/native-map-app.md)
...
### Indicate activity
#### [ActivityIndicator](user-interface/activityindicator.md)
...
#### [SwipeView Swipe Transition Mode](platform/android/swipeview-swipetransitionmode.md)
...
#### [SwipeView Swipe Transition Mode](platform/ios/swipeview-swipetransitionmode.md)
...
### [App Theme](~/essentials/app-theme.md?context=xamarin/xamarin-forms)
...
### [Permissions](~/essentials/permissions.md?context=xamarin/xamarin-forms)
