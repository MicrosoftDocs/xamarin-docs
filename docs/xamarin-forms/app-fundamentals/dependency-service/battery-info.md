...
description: "This article explains how to use the Xamarin.Forms DependencyService class to access battery information natively for each platform."
ms.prod: xamarin
...
[![Download Sample](~/media/shared/download.png) Download the sample](https://developer.xamarin.com/samples/xamarin-forms/DependencyService/)
