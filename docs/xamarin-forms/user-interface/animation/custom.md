...
There are a number of differences between an [`Animation`](https://developer.xamarin.com/api/type/Xamarin.Forms.Animation/) object that uses child animations, and one that doesn't:
