...
- [Local Notifications in Xamarin.Forms](https://docs.microsoft.com/en-gb/xamarin/xamarin-forms/app-fundamentals/local-notifications)
- [Xamarin.Forms splash screen](https://docs.microsoft.com/en-gb/xamarin/xamarin-forms/user-interface/splashscreen)
- [Xamarin.Forms common control properties, methods, and events](https://docs.microsoft.com/en-gb/xamarin/xamarin-forms/user-interface/controls/common-properties)
- [What is Xamarin?](https://docs.microsoft.com/en-gb/xamarin/get-started/what-is-xamarin)
- [What is Xamarin.Forms?](https://docs.microsoft.com/en-gb/xamarin/get-started/what-is-xamarin-forms)
