...
- [Consume an ASP.NET Web Service (ASMX)](~/xamarin-forms/data-cloud/consuming/asmx.md)
- [Consume a Windows Communication Foundation (WFC) Service](~/xamarin-forms/data-cloud/consuming/wcf.md)
- [Authenticate Users with Azure Active Directory B2C](~/xamarin-forms/data-cloud/authentication/azure-ad-b2c.md)
- [Integrate Azure Active Directory B2C with Azure Mobile Apps](~/xamarin-forms/data-cloud/authentication/azure-ad-b2c-mobile-app.md)
