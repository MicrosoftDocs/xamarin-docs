...
- [Fonts: Cross-platform font support](~/xamarin-forms/user-interface/text/fonts.md#use-a-custom-font-preview)
...
- [Detect dark mode in Xamarin.Forms applications](~/xamarin-forms/user-interface/theming/dark-mode.md)
