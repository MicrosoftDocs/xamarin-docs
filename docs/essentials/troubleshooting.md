...
To do this, add the NuGet that is the source of the conflict manually, and use the **Version** list to select a specific version. Currently version 27.0.2 of the Xamarin.Android.Support.Compat NuGet will resolve this error.
